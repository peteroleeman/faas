...
//foodio related
  ...
  ..get('/clearplus/<storeId>/<summaryId>', (Request request, String storeId, String summaryId)  async {

    final result = await clearPlus(storeId, summaryId);
...
Future<String> clearPlus(String storeId, String summaryId) async
{
